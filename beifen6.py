...
def main():
    ...
    for each_list in car:
        ...
        for i in range(0, len(b) - 1):
            edge = h.getEdge(b[i], b[i + 1])
            Road = edge.getRoadlabel()
            single_road.append(Road)
        single_road.insert(0, each_list[0])
        if each_list[3] == 8:
            single_road.insert(1, each_list[4]*2)
        elif each_list[3] == 6:
            single_road.insert(1, each_list[4]*2 + 80)
        elif each_list[3] == 4:
            single_road.insert(1, each_list[4]*2 + 165)
        else:
            single_road.insert(1, each_list[4]*4 + 280)
