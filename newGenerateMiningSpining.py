...
def main():
    ...
    car = read_data('F:\\pycharm my project\\SDK\\SDK_python\\CodeCraft-2019\\1-map-exam-2\\car.txt')
    cross = read_data('F:\\pycharm my project\\SDK\\SDK_python\\CodeCraft-2019\\1-map-exam-2\\cross.txt')
    road = read_data('F:\\pycharm my project\\SDK\\SDK_python\\CodeCraft-2019\\1-map-exam-2\\road.txt')
    answer_path = 'F:\\pycharm my project\\SDK\\SDK_python\\CodeCraft-2019\\1-map-exam-2\\answer.txt'
    aa = len(cross)
    ...
    for each_list in car:
        ...
        if each_list[3] == 16:
            ...
            single_road.insert(1, each_list[4]*2 + 200)
        elif each_list[3] == 12:
            single_road.insert(1, each_list[4]*2 + 410)
        elif each_list[3] == 10:
            single_road.insert(1, each_list[4]*2 + 640)
        elif each_list[3] == 8:
            single_road.insert(1, each_list[4]*2 + 900)
        elif each_list[3] == 6:
            single_road.insert(1, each_list[4]*2 + 1200)
        else:
            single_road.insert(1, each_list[4]*2 + 1450)
...
# def add_sideroad(single_path, sideroad):
#     sideroad1 = sideroad[0]
#     sideroad2 = sideroad[1]
#     if single_path[0] in sideroad1 and single_path[-1] in sideroad1:
#         a = sideroad1.index(single_path[-1])
#         b = sideroad1.index(single_path[0])
#         if a >= b:
#                 single_path1 = sideroad1[b:a+1]
#                 return single_path1
#         elif a < b:
#             temp = sideroad1[a:b+1]
#             single_path1 = temp[::-1]
#             return single_path1
#     return single_path
...
def add_road2(road):
    for each_list in road:
        h.addEdge(each_list[4], each_list[5], [int(each_list[0]), int(each_list[1]), int(each_list[2]), int(each_list[3])])
        if each_list[6] == 1:
            h.addEdge(each_list[5], each_list[4], [int(each_list[0]), int(each_list[1]), int(each_list[2]), int(each_list[3])])
